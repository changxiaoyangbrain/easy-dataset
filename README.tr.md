...
NuCorpus , Büyük Dil Modelleri (LLM'ler) için özel olarak tasarlanmış ince ayar veri setleri oluşturmak için bir uygulamadır. Alana özgü dosyaları yüklemek, içeriği akıllıca bölmek, sorular oluşturmak ve model ince ayarı için yüksek kaliteli eğitim verileri üretmek için sezgisel bir arayüz sağlar.

NuCorpus  ile alan bilgisini yapılandırılmış veri setlerine dönüştürebilir, OpenAI formatını takip eden tüm LLM API'leriyle uyumlu çalışabilir ve ince ayar sürecini basit ve verimli hale getirebilirsiniz.
...
NuCorpus , aşağıdakiler dahil olmak üzere birden fazla AI sağlayıcısını destekler:
...
@misc{easy-dataset-2025,
  title={NuCorpus : A Tool for Creating Fine-tuning Datasets for Large Language Models},
  author={Conard Li},
  year={2025},
  publisher={GitHub},
