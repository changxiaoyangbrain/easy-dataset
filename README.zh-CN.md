...
NuCorpus  是一个专为创建大型语言模型（LLM）微调数据集而设计的应用程序。它提供了直观的界面，用于上传特定领域的文件，智能分割内容，生成问题，并为模型微调生成高质量的训练数据。

通过 NuCorpus ，您可以将领域知识转化为结构化数据集，兼容所有遵循 OpenAI 格式的 LLM API，使微调过程变得简单高效。
...
- 查看本项目的演示视频：[NuCorpus  演示视频](https://www.bilibili.com/video/BV1y8QpYGE57/)
- 查看本项目的论文：[NuCorpus : A Unified and Extensible Framework for Synthesizing LLM Fine-Tuning Data from Unstructured Documents](https://arxiv.org/abs/2507.04009v1)

## 社区教程

- [NuCorpus  × LLaMA Factory: 让大模型高效学习领域知识](https://buaa-act.feishu.cn/wiki/KY9xwTGs1iqHrRkjXBwcZP9WnL9)
- [NuCorpus  使用实战: 如何构建高质量数据集？](https://www.bilibili.com/video/BV1MRMnz1EGW)
- [NuCorpus  1.4 重点功能更新解读](https://www.bilibili.com/video/BV1fyJhzHEb7/)
- [NuCorpus  1.6 重点功能更新解读](https://www.bilibili.com/video/BV1Rq1hBtEJa/)
...
我们欢迎社区的贡献！如果您想为 NuCorpus  做出贡献，请按照以下步骤操作：
